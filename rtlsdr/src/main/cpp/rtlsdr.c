...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if((rtlDeviceClass = createGlobalClassRef(env, "com/donfbecker/rtlsdr/RtlDevice")) == NULL) return 0;
    if((rtlCallbackInterface = createGlobalClassRef(env, "com/donfbecker/rtlsdr/RtlCallback")) == NULL) return 0;
    if((rtlExceptionClass = createGlobalClassRef(env, "com/donfbecker/rtlsdr/RtlException")) == NULL) return 0;
    if((usbStringsClass = createGlobalClassRef(env, "com/donfbecker/rtlsdr/UsbStrings")) == NULL) return 0;
    if((xtalFreqClass = createGlobalClassRef(env, "com/donfbecker/rtlsdr/XtalFreq")) == NULL) return 0;
    ...
    if((rtlCallbackMethod = (*env)->GetMethodID(env, rtlCallbackInterface, "rtlData", "(Ljava/nio/ByteBuffer;I)V")) == NULL) return 0;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_openDevice( JNIEnv *env, jobject obj, jint fd) {
    int ret;
    rtlsdr_dev_t *dev;
    jint jdevIndex;
    jlong jdevHandle;
    ...
    if(jdevHandle != 0L) {
        throwNewRtlException(env, "There is another active device handle for index %i.", (int)jdevIndex);
        return;
    }

    ret = rtlsdr_open_android(&dev, fd);

    if(ret != 0) {
        throwNewRtlException(env, "rtlsdr_open_android returned %i", ret);
        return;
    }
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_close(JNIEnv *env, jobject obj) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setXtalFreq(JNIEnv *env, jobject obj, jobject xtalFreq) {
    int ret;
    jlong jdevHandle;
    ...
    ret = rtlsdr_set_xtal_freq((rtlsdr_dev_t *)jdevHandle, (uint32_t)rtlFreq, (uint32_t)tunerFreq);

    if(ret != 0) throwNewRtlException(env, "rtlsdr_set_xtal_freq returned %i", ret);

}

JNIEXPORT jobject JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getXtalFreq(JNIEnv *env, jobject obj) {
    int ret;
    ...
    return (*env)->NewObject(env, xtalFreqClass, mid, (jint)rtl_freq, (jint)tuner_freq);

}

JNIEXPORT jobject JNICALL  Java_com_donfbecker_rtlsdr_RtlDevice_getUsbStrings(JNIEnv *env, jobject obj) {
    int ret;
    ...
    mid = (*env)->GetMethodID(env, usbStringsClass, "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
    if((*env)->ExceptionCheck(env) == JNI_TRUE) return NULL;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_writeEeprom(JNIEnv *env, jobject obj, jbyteArray data, jint offset, jint len) {
    int ret;
    jlong jdevHandle;
    jbyte *bytes;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_readEeprom(JNIEnv *env, jobject obj, jbyteArray data, jint offset, jint len) {
    int ret;
    jlong jdevHandle;
    jbyte *bytes;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setCenterFreq(JNIEnv *env, jobject obj, jlong freq) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT jlong JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getCenterFreq(JNIEnv *env, jobject obj) {
    uint32_t ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setFreqCorrection(JNIEnv *env, jobject obj, jint ppm) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT jint JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getFreqCorrection(JNIEnv *env, jobject obj) {
    jlong jdevHandle;
...
JNIEXPORT jint JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getTunerType(JNIEnv *env, jobject obj) {
    jlong jdevHandle;
...
JNIEXPORT jintArray JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getTunerGains(JNIEnv *env, jobject obj) {
    int ret;
    int gains[0x40];
    jlong jdevHandle;
    jintArray jintGains;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setTunerGain(JNIEnv *env, jobject obj, jint gain) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT jint JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getTunerGain(JNIEnv *env, jobject obj) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setTunerIfGain(JNIEnv *env, jobject obj, jint stage, jint gain) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setTunerGainMode(JNIEnv *env, jobject obj, jint mode) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setSampleRate(JNIEnv *env, jobject obj, jint rate) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT jint JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getSampleRate(JNIEnv *env, jobject obj) {
    uint32_t ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setTestMode(JNIEnv *env, jobject obj, jint on) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setAgcMode(JNIEnv *env, jobject obj, jint on) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT jint JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getDirectSampling(JNIEnv *env, jobject obj) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_setOffsetTuning(JNIEnv *env, jobject obj, jint on) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT jint JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_getOffsetTuning(JNIEnv *env, jobject obj) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_resetBuffer(JNIEnv *env, jobject obj) {
    int ret;
    jlong jdevHandle;
...
JNIEXPORT jint JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_readSync(JNIEnv *env, jobject obj, jobject buf, jint len) {
    int ret, read;
    void* addr;
...
JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_readAsync(JNIEnv *env, jobject obj, jobject jcb, jint numBuffers, jint bufferLen) {
    ...
    ret = rtlsdr_read_async((rtlsdr_dev_t *)jdevHandle,AsyncCallback, &ctx, (uint32_t)numBuffers, (uint32_t)bufferLen);
    if(ret != 0) throwNewRtlException(env, "rtlsdr_read_async returned %i", ret);

}

JNIEXPORT void JNICALL Java_com_donfbecker_rtlsdr_RtlDevice_cancelAsync(JNIEnv *env, jobject obj) {
    int ret;
    jlong jdevHandle;
